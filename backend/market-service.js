...
function seedMarketData() {
  ...
  if (existingMarkets.count === 0) {
    // Seed market centers
    const markets = [
      { name: 'Siaya Town Market', location: 'Siaya', county: 'Siaya', sub_county: 'Siaya', operating_days: 'Mon-Sat', main_crops: 'Maize,Beans,Rice' },
      { name: 'Bondo Market', location: 'Bondo', county: 'Siaya', sub_county: 'Bondo', operating_days: 'Mon-Sun', main_crops: 'Maize,Sorghum,Cassava' },
      { name: 'Yala Market', location: 'Yala', county: 'Siaya', sub_county: 'Yala', operating_days: 'Tue-Sun', main_crops: 'Rice,Vegetables,Beans' },
    ...
    const prices = [
      ...
      { crop: 'Sweet Potatoes', market: 'Yala Market', price: 42, unit: 'kg' },
